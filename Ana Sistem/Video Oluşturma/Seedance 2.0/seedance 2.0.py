...
def seedance_20_toplu(auto_download: bool = True, force_relogin: bool = False):
    ...
    print(f"  Ses: {settings['ses']} (Seedance 2.0 CLI'da uygulanacak)")
...
def main():
    parser = argparse.ArgumentParser(description="Seedance 2.0 - app.py ile entegre toplu sürüm")
    ...
    try:
        ...
        seedance_20_toplu(auto_download=not args.no_download, force_relogin=args.force_relogin)
    except SystemExit:
        raise
